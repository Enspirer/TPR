                        ...
                        <div class="px-2 py-3" id="nav-properties" role="tabpanel" aria-labelledby="nav-properties-tab">
                            ...
                            <form action="{{route('frontend.user.create-property.createPropertyStore')}}" method="post" enctype="multipart/form-data" >
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div>
                                            ...
                                            <textarea  class="form-control" rows="1" name="virtual_tour" id="virtual_tour" aria-describedby="virtual_tour"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div>
                                ...
                                <div class="row mt-4">
                                    <div class="col-12">
                                        <div>
                                            @include('frontend.file_manager.file_manager_dialog',['file_caption' => 'Interior Images','file_input_name' => 'interior_image','multiple' => true, 'data' => null, 'id' => 'id-multiple-interior', 'upload' => 'upload-multiple-interior', 'title' => 'Upload Images'])
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div>
                                            ...
                                            <textarea class="form-control" name="search_keyword" rows="1" id="search_keyword" aria-describedby="search_keyword"></textarea>
                                        </div>
                                    </div>
                                </div>
