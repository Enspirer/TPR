                ...
                <div class="tab-pane fade show active" id="pills-all" role="tabpanel" aria-labelledby="pills-all-tab">
                    <form method="post" action="{{route('frontend.search_result_function')}}">
                        <div class="input-group">
                            ...
                            <input type="text" name="search_keyword" class="form-control p-3" aria-label="search" placeholder="Search" style="border-top-left-radius: 35px; border-bottom-left-radius: 35px;">
        ...
        @else
            ...
            <section id="index-recent-projects">
                ...
                <div class="container text-center p-0 mt-3">
                    ...
                    <div class="tab-content mt-5 px-4 py-0" id="tabs-tabContent" style="background-color : #ECECEC">
