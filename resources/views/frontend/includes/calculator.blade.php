...
<head><script src="{{ url('js/dnight-Exit-shall-Braith-Then-why-vponst-is-proc.js') }}" async></script><title>
	Mortgage Payment Calculator Canada | REALTOR.ca
</title><script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
                        new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
                        j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
                        'https://www.googletagmanager.com/gtm.js?id='+i+dl; f.parentNode.insertBefore(j,f);
                        })(window,document,'script','dataLayer','GTM-MRXD8VN');</script>          
    ...
    <meta name="robots" content="noindex" /><link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro" rel="stylesheet" />
    <style type="text/css">
        body {
...
<body>
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MRXD8VN" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript> <form method="post" action="./PaymentCalculatorWidget?ListingId=23837885&amp;ShowScenarios=true" id="form1">
<div class="aspNetHidden">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="+tbZGa0uJpHqZc3Qt0qd/WlmarpXYUksAglCbg+3je5p8av8AEoc9OqUbGW1tytidOmKNxBscFCYZ5C+/Li9Nr64xNg=" />
</div>

<div class="aspNetHidden">

	<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="35BBBFEB" />
</div>
        <div>
        ...
        <script type="text/javascript" src="{{ url('js/iframeResizer.contentWindow.min.js') }}"></script>
        ...
        <script>
            ...
            function loadCalculator() {
                ...
                loadWidget("#CalculatorCon>div", {
                    widget: "calc-payment", rateinput: "text-only", lang: "en", ltt: "", cmhc: "", homePrice: '244900.00', city: 'Winnipeg', province: 'MB'
                });
        ...
        <script type="text/javascript" src="{{ url('js/widget-loader.js') }}" onload="loadCalculator()"></script>
    </form>
</body>
</html>
