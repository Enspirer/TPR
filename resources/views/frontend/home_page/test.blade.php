...
<section id="index-recent-projects">
    ...
    <div class="container-fluid p-3 text-center text-white" style="background-color: #156073">
        <h3 class="fw-bolder" data-aos="fade-up" data-aos-duration="500">Property Market in
            {{ get_country_cookie(request())->country_name }}</h3>
    </div>
    ...
    <div class="container text-center p-0 mt-3" data-aos="fade-up" data-aos-duration="500">
        <ul class="nav mb-3 justify-content-center" id="projects-tab" role="tablist">
            ...
            @if(App\Models\HomePageAdvertisement::where('category',$ad_cat->id)->where('admin_approval','=','Approved')->where('country_manager_approval','=','Approved')->where('status','=','Enable')->first()
            == null)

            @else
            <li class="nav-item project-item" role="presentation" data-aos="fade-up" data-aos-duration="500"
                data-aos-delay="300">
                <a class="nav-link tabs" id="tab-id{{ $ad_cat->id }}" data-bs-toggle="tab"
                    data-bs-target="#tab{{ $ad_cat->id }}" type="button" role="tab"
                    aria-controls="tab-{{ $ad_cat->id }}" aria-selected="false">{{ $ad_cat->name }}</a>
            </li>
        ...
        <div class="tab-content mt-md-5 py-0" id="tabs-tabContent">
            ...
            @foreach($ad_category as $key => $ad_cat)
            <div class="tab-pane fade" id="tab{{ $ad_cat->id }}" role="tabpanel"
                aria-labelledby="tab-id{{ $ad_cat->id }}">
                <div class="swiper container mySwiper2">
                    <div class="swiper-wrapper">

                        @foreach(App\Models\HomePageAdvertisement::where('category',$ad_cat->id)->where('status','=','Enable')->where('admin_approval','=','Approved')->where('country_manager_approval','=','Approved')->orderBy('order','ASC')->get()
                        as $data)
            ...
            <div class="col-12 col-md-3 mb-4 mb-md-0" style="background-color: #F3F3F3">
                ...
                <div class="properties">
                    ...
                    <div class="row border align-items-center p-1">
                        <div class="col-6">
                            <a href="{{ route('frontend.individual-property', $property->id) }}"><img
                                    src="{{url('image_assest', $property->feature_image_id)}}" alt="" class="img-fluid"
                        ...
                        <div class="col-6">
                            ...
                            <p class="mb-0" style="font-size: 0.8rem;">Transaction Type:
                                {{ $property->transaction_type }}</p>
            ...
            <div class="col-12 col-md-4 mb-4 mb-md-0" data-aos="fade-up" data-aos-duration="500" data-aos-delay="100">
                <div class="card p-4 custom-shadow border-0 home-card">
                    ...
                    <div class="card-body mt-4 p-2">
                        <h4 class="card-title text-center mb-4">Map Search s</h4>
    ...
    <div class="container " style="margin-top:7rem">
        ...
        <div class="home-featured" style="margin-top: 6rem">
            ...
            <h4 data-aos="fade-up" data-aos-duration="500" data-aos-delay="100">
                {{ json_decode($country->features_manager)[0]->title }}</h4>
                    ...
                    <div class="card p-4 custom-shadow border-0">
                        ...
                        <div class="card-body mt-4">
                            ...
                            <p class="card-text mt-3 mb-1">Transaction Type:
                                {{ App\Models\Properties::where('id', $prop)->first()->transaction_type }}</p>
                            <p class="card-text">Country:
                                {{ App\Models\Properties::where('id', $prop)->first()->country }}</p>
        ...
        <div class="home-featured" style="margin-top: 6rem">
            <h4 data-aos="fade-up" data-aos-duration="500" data-aos-delay="100">
                {{ json_decode($country->features_manager)[1]->title }}</h4>
...
@if(App\Models\Properties::where('country',get_country_cookie(request())->country_name)->where('sold_request','Sold')->where('admin_approval','Approved')->where('country_manager_approval','=','Approved')->first()
== null)
                ...
                <div class="swiper container mySwiper" data-aos="fade-up" data-aos-duration="500">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="card">
                                <div class="card-body">
                                    <a href="{{ route('frontend.individual-property', $sold->id) }}"
                                        style="text-decoration:none">
                                        <img src="{{url('image_assest',$sold->feature_image_id)}}" class="img-fluid"
...
function initMap() {
    ...
    const contentString = ` <div id="content">
                <h2>This is popup ${nameList[0].name} content </h2>
